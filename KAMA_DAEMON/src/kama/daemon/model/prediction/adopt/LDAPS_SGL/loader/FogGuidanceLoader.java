...
public class FogGuidanceLoader
{
    ...
    private int id = 602, jd = 781, nt = 12;
    ...
    private void Parse() throws IOException
    {
        ...
        lambert_param.grid = 1.5; // for 6 km [격자간격] // LC 1.5 // 6
        ...
        lambert_param.xo = 301.0; // for 6 km [기준점의 X좌표] // 262 (평면좌표의 x 길이를 반으로 나눈 값)
        lambert_param.yo = 390.0; // for 6 km [기준점의 Y좌표] // 419 (평면좌표의 y 길이를 반으로 나눈 값)
    ...
    public double getVisbValue(double lat, double lon)
    {
        ...
        return _visb_info_calculated[(int)coord.getX()][(int)coord.getY()];
    }
