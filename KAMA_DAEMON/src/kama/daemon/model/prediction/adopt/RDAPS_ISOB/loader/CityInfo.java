...
public class CityInfo
{
    ...
    public static List<CityInfo> loadCityInfo(String filePath) throws IOException
    {
        ...
        for (int i = 2; i < lines.size(); i++)
        {
            ...
            pos += 5; // A5
            pos += 8;
            cityInfo.glat = Double.parseDouble(line.substring(pos, pos + 8));
            pos += 8;
            cityInfo.glon = Double.parseDouble(line.substring(pos, pos + 8));
            pos += 8;
            cityInfo.olat = Double.parseDouble(line.substring(pos, pos + 8));
            pos += 8;
            cityInfo.olon = Double.parseDouble(line.substring(pos, pos + 8));
            pos += 8;
            pos += 1;  // 1X
