...
public class FogHumidityLoader
{
    ...
    private int IERRF = 6, LUNIT = 2, IWTYPE = 21, IWKID = 1, IPG = 4, NT = 30;
    private int ID = 40, JD = 40, LRWK = 30000, LIWK = 30000, ICNT_SMOTH = 1;
    ...
    private double XO = 21.0;   //          ! [grid]   : X-coordinate of known point
    private double YO = 20.0;   //          ! [grid]   : Y-coordinate of known point
    private double DD = 30.0;   //         ! [km]     : Grid distance in map
