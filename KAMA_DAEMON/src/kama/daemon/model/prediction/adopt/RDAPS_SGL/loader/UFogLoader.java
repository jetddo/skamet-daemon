...
public class UFogLoader
{
    ...
    private int id = 150, jd = 129, ks = 2, nt = 88, lrwk = 30000, liwk = 30000;
    private int kxs = 1, kxe = id, kys = 1, kye = 797, itsm = 10, ism = 10;
    ...
    private double XO = 72.0;   //          ! [grid]   : X-coordinate of known point
    private double YO = 67.0;   //          ! [grid]   : Y-coordinate of known point
    private double DD = 10.0;   //         ! [km]     : Grid distance in map
