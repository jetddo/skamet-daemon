 ...
 */
public class GDPS_SIGWX_DataProcess extends DataProcessor
{
    private static final String DATAFILE_PREFIX = "gdps_sigwx";
    ...
    public GDPS_SIGWX_DataProcess(DaemonSettings settings)
    {
