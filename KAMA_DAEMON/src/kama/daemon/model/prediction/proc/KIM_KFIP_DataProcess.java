 ...
 */
public class KIM_KFIP_DataProcess extends DataProcessor
{
    private static final String DATAFILE_PREFIX = "kim_kfip";
    ...
    public KIM_KFIP_DataProcess(DaemonSettings settings)
    {
