 ...
 */
public class SHEAR_IMG_DataProcess extends DataProcessor
{
    private static final String DATAFILE_PREFIX = "shear_img";
    ...
    public SHEAR_IMG_DataProcess(DaemonSettings settings)
    {
