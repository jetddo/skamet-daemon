 ...
 */
public class KIM_DWIND_DataProcess extends DataProcessor
{
    private static final String DATAFILE_PREFIX = "kim_dwind";
    ...
    public KIM_DWIND_DataProcess(DaemonSettings settings)
    {
