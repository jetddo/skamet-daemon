 ...
 */
public class KIM_ACIM_CNVT_DataProcess extends DataProcessor
{
    private static final String DATAFILE_PREFIX = "kim_acim_cnvt";
    ...
    public KIM_ACIM_CNVT_DataProcess(DaemonSettings settings)
    {
        super(settings, DATAFILE_PREFIX);
        
        this.insertHistory = false;
        this.insertRealTable = false;
    }
