 ...
 */
public class ECMW_SIGWX_DataProcess extends DataProcessor
{
    private static final String DATAFILE_PREFIX = "ecmw_sigwx";
    ...
    public ECMW_SIGWX_DataProcess(DaemonSettings settings)
    {
