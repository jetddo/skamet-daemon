...
import kama.daemon.common.util.model.image.IcingEaImageGenerator;
import ucar.nc2.dataset.NetcdfDataset;

/**
 * Created by chlee on 2017-02-15.
 */
public class ICING_EA2_DataProcess extends DataProcessor
{
    ...
    public ICING_EA2_DataProcess(DaemonSettings settings) throws IOException {
        super(settings, DATAFILE_PREFIX);
    }

    private void generateIcingEaImageFiles(File icingEaFile, DatabaseManager dbManager, ProcessorInfo processorInfo, String attrName, String varName) {
        
    	String icingEaImgSavePath = processorInfo.FileSavePath.replaceAll("/ICING_EA/", "/ICING_EA_IMG/");
    			
        File saveFolder = new File(icingEaImgSavePath);
        ...
        IcingEaImageGenerator icingEaImageGenerator = new IcingEaImageGenerator(dbManager, processorInfo, attrName, varName);
        
        try {
        	
        	NetcdfDataset ncFile = NetcdfDataset.acquireDataset(icingEaFile.getAbsolutePath(), null);
            
            icingEaImageGenerator.generateImages(ncFile, icingEaFile.getName(), icingEaImgSavePath); 
    ...
    protected void processDataByFileGroup(DatabaseManager dbManager, File[] dataFiles, ProcessorInfo processorInfo) throws Exception
    {
        ...
        for (File file : dataFiles)
        {
            ...
            this.generateIcingEaImageFiles(file, dbManager, processorInfo, "ICING_EA", "RAP");
