 ...
 */
public class ALA_METEO_IMG_DataProcess extends DataProcessor
{
    private static final String DATAFILE_PREFIX = "ala_meteo_img";
    ...
    public ALA_METEO_IMG_DataProcess(DaemonSettings settings)
    {
