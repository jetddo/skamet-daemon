...
import kama.daemon.common.util.model.image.KtgImageGenerator;
import ucar.nc2.dataset.NetcdfDataset;

public final class KTG2_DataProcess extends DataProcessor {

    private static final String DATAFILE_PREFIX = "ktg";
	...
	public KTG2_DataProcess(final DaemonSettings settings) throws IOException {
		super(settings, "ktg");
	}

	private void generateKtgImageFiles(File ktgFile, DatabaseManager dbManager, ProcessorInfo processorInfo, String attrName, String varName) {
        
    	String ktgImgSavePath = processorInfo.FileSavePath.replaceAll("/KTG/", "/KTG_IMG/");
        ...
        KtgImageGenerator ktgImageGenerator = new KtgImageGenerator(dbManager, processorInfo, attrName, varName);
    ...
    protected void processDataByFileGroup(DatabaseManager dbManager, File[] dataFiles, ProcessorInfo processorInfo) throws Exception
    {
        ...
        for (File file : dataFiles)
        {
            ...
            this.generateKtgImageFiles(file, dbManager, processorInfo, "KTG", "KTG_AUC_20");	
