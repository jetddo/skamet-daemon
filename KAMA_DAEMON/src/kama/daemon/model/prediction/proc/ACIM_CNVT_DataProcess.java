 ...
 */
public class ACIM_CNVT_DataProcess extends DataProcessor
{
    private static final String DATAFILE_PREFIX = "acim_cnvt";
    ...
    public ACIM_CNVT_DataProcess(DaemonSettings settings)
    {
