 ...
 */
public class LDPS_SIGWX_DataProcess extends DataProcessor
{
    private static final String DATAFILE_PREFIX = "ldps_sigwx";
    ...
    public LDPS_SIGWX_DataProcess(DaemonSettings settings)
    {
