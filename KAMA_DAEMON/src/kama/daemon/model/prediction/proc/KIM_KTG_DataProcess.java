 ...
 */
public class KIM_KTG_DataProcess extends DataProcessor
{
    private static final String DATAFILE_PREFIX = "kim_ktg";
    ...
    public KIM_KTG_DataProcess(DaemonSettings settings)
    {
