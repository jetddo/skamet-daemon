...
import kama.daemon.common.util.model.image.KimGdpsWintemImageGenerator;
import ucar.nc2.dataset.NetcdfDataset;

/**
 * Created by chlee on 2017-02-15.
 */
public class KIM_GDPS_DataProcess extends DataProcessor
{
    private static final String DATAFILE_PREFIX = "kim_gdps";
    ...
    public KIM_GDPS_DataProcess(DaemonSettings settings)
    {
...
private void sendFileToAcom(List<Map<String, Object>> fileInfoList, ProcessorInfo processorInfo) {
	...
	private void generateKimGdpsWintemImageFiles(File kimGdpsFile, DatabaseManager dbManager, ProcessorInfo processorInfo) {
	    
		String kimGdpsImgSavePath = processorInfo.FileSavePath.replaceAll("/KIM_GDPS/", "/KIM_GDPS_WINTEM/");
	 			
	    File saveFolder = new File(kimGdpsImgSavePath);
	    ...
	    KimGdpsWintemImageGenerator kimGdpsWintemImageGenerator = new KimGdpsWintemImageGenerator(dbManager, processorInfo);
	    ...
	    try {
	        ...
	        List<Map<String, Object>> fileInfoList1 = kimGdpsWintemImageGenerator.generateImages(ncFile, kimGdpsFile.getName(), kimGdpsImgSavePath, paramMap1);
	        ...
	        List<Map<String, Object>> fileInfoList2 = kimGdpsWintemImageGenerator.generateImages(ncFile, kimGdpsFile.getName(), kimGdpsImgSavePath, paramMap2);
