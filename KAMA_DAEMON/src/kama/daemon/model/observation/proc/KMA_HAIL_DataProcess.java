...
import kama.daemon.model.observation.adopt.RDR.proc.RadarKmaHailConveter;
import kama.daemon.model.observation.adopt.RDR.proc.RadarKmaHciConveter;

/**
 * @author chlee
 * Created on 2017-01-03.
 */
public class KMA_HAIL_DataProcess extends DataProcessor
{
    private static final String DATAFILE_PREFIX = "kma_hail";
    ...
    public KMA_HAIL_DataProcess(DaemonSettings settings)
    {
    ...
    protected void processDataInternal(DatabaseManager dbManager, File file, ProcessorInfo processorInfo) throws Exception
    {
        ...
        RadarKmaHailConveter converter = new RadarKmaHailConveter(dbManager.Settings, processorInfo);        
