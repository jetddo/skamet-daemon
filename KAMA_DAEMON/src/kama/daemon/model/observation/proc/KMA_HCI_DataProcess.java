 ...
 */
public class KMA_HCI_DataProcess extends DataProcessor
{
    private static final String DATAFILE_PREFIX = "kma_hci";
    ...
    public KMA_HCI_DataProcess(DaemonSettings settings)
    {
    ...
    protected void processDataInternal(DatabaseManager dbManager, File file, ProcessorInfo processorInfo) throws Exception
    {
        ...
        RadarKmaHciConveter converter = new RadarKmaHciConveter(dbManager.Settings, processorInfo);        
