 ...
 */
public class SEAVIS_IMG_DataProcess extends DataProcessor
{
    private static final String DATAFILE_PREFIX = "seavis_img";
    ...
    public SEAVIS_IMG_DataProcess(DaemonSettings settings)
    {
    ...
    protected void processDataInternal(DatabaseManager dbManager, File file, ProcessorInfo processorInfo) throws Exception
    {
    	...
    	String obsDtStr = sdf.format(processorInfo.FileDateFromNameOriginal);
    	
    	String stnId = file.getName().split("_")[3].split("\\.")[0].split("\\-")[0];
    	
    	String query = "INSERT INTO AAMI.SEAVIS_IMG_L(STN_ID, OBS_DT, IMG_FILE_NAME) VALUES "+
    				   "( " + stnId + ", TO_DATE('" + obsDtStr + "','YYYYMMDDHH24MI'), '" + file.getName() + "')";
