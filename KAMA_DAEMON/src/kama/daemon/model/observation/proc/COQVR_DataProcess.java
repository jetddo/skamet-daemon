 ...
 */
public class COQVR_DataProcess extends RDRImgDataProcessor
{
    private static final String DATAFILE_PREFIX = "coqvr";
    private static final int DB_COLUMN_COUNT = 3;
    private static final int FILE_DATE_INDEX_POS = 3; // RDR_COQVR_MND_201609231440.dat.gz
    ...
    public COQVR_DataProcess(DaemonSettings settings)
    {
...
//        processRDRImage(dbManager, file, processorInfo);
    ...
    {
        // ******* 기존 AAMI 버전 3D 파싱용 *******
        defineQueryFormat(INSERT_QUERY_OLD_1, "INSERT INTO %%WORKSPACE_OLD_AAMI%%.RDR_WIND(TM, FILENAME) VALUES (TO_DATE(''{0}'', ''YYYY-MM-DD HH24:mi:ss''), ''{1}'')");
        defineQueryFormat(INSERT_QUERY_OLD_2, "INSERT INTO %%WORKSPACE_OLD_AAMI%%.RDR_WIND_B(TM, FILENAME) VALUES (TO_DATE(''{0}'', ''YYYY-MM-DD HH24:mi:ss''), ''{1}'')");
        defineQueryFormat(DELETE_QUERY_OLD, "DELETE %%WORKSPACE_OLD_AAMI%%.RDR_WIND");
    }
    //</editor-fold>
