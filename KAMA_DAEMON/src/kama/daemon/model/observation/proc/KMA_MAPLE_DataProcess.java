...
import kama.daemon.model.observation.adopt.RDR.proc.RadarKmaMapleConveter;

/**
 * @author chlee
 * Created on 2017-01-03.
 */
public class KMA_MAPLE_DataProcess extends DataProcessor
{
    private static final String DATAFILE_PREFIX = "kma_maple";
    ...
    public KMA_MAPLE_DataProcess(DaemonSettings settings)
    {
    ...
    protected void processDataInternal(DatabaseManager dbManager, File file, ProcessorInfo processorInfo) throws Exception
    {
        ...
        RadarKmaMapleConveter converter = new RadarKmaMapleConveter(dbManager.Settings, processorInfo);        
