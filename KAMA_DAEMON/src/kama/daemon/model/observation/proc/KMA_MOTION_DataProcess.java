...
import kama.daemon.model.observation.adopt.RDR.proc.RadarKmaMotionConveter;

/**
 * @author chlee
 * Created on 2017-01-03.
 */
public class KMA_MOTION_DataProcess extends DataProcessor
{
    private static final String DATAFILE_PREFIX = "kma_motion";
    ...
    public KMA_MOTION_DataProcess(DaemonSettings settings)
    {
    ...
    protected void processDataInternal(DatabaseManager dbManager, File file, ProcessorInfo processorInfo) throws Exception
    {
        ...
        RadarKmaMotionConveter converter = new RadarKmaMotionConveter(dbManager.Settings, processorInfo);        
