 ...
 */
public class GK2A_IMG_DataProcess extends DataProcessor
{
    private static final String DATAFILE_PREFIX = "gk2a_img";
    ...
    public GK2A_IMG_DataProcess(DaemonSettings settings)
    {
