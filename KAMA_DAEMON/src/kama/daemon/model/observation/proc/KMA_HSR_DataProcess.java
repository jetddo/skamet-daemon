...
import kama.daemon.model.observation.adopt.RDR.proc.RadarKmaHsrConveter;

/**
 * @author chlee
 * Created on 2017-01-03.
 */
public class KMA_HSR_DataProcess extends DataProcessor
{
    private static final String DATAFILE_PREFIX = "kma_hsr";
    ...
    public KMA_HSR_DataProcess(DaemonSettings settings)
    {
    ...
    protected void processDataInternal(DatabaseManager dbManager, File file, ProcessorInfo processorInfo) throws Exception
    {
        ...
        RadarKmaHsrConveter converter = new RadarKmaHsrConveter(dbManager.Settings, processorInfo);        
