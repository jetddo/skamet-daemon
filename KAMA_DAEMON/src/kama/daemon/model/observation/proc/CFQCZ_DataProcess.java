 ...
 */
public class CFQCZ_DataProcess extends RDRImgDataProcessor
{
    private static final String DATAFILE_PREFIX = "cfqcz";
    ...
    public CFQCZ_DataProcess(DaemonSettings settings)
    {
    ...
    {
        // ******* 기존 AAMI 버전 3D 파싱용 *******
        defineQueryFormat(INSERT_QUERY_OLD_1, "INSERT INTO %%WORKSPACE_OLD_AAMI%%.RDR_QC(TM, FILENAME) VALUES (TO_DATE(''{0}'', ''YYYY-MM-DD HH24:mi:ss''), ''{1}'')");
        defineQueryFormat(INSERT_QUERY_OLD_2, "INSERT INTO %%WORKSPACE_OLD_AAMI%%.RDR_QC_B(TM, FILENAME) VALUES (TO_DATE(''{0}'', ''YYYY-MM-DD HH24:mi:ss''), ''{1}'')");
        defineQueryFormat(DELETE_QUERY_OLD, "DELETE %%WORKSPACE_OLD_AAMI%%.RDR_QC");
    }
    //</editor-fold>
