...
public class RadarKmaMotionConveter {
	...
	private Lambert lambert = new Lambert(GRID_PARAM_TYPE.RDR_KMA_MOTION);
	...
	public RadarKmaMotionConveter(DaemonSettings daemonSettings, ProcessorInfo processorInfo) {		
	...
	public void parseRadarFile(File radarGZipFile) {
		...
		System.out.println(this.logDateFormat.format(new Date(System.currentTimeMillis())) + " -> ::::: Start KMA MOTION Radar Image Converter :::::");
		...
		try {
			...
			System.out.println(this.logDateFormat.format(new Date(System.currentTimeMillis())) + " -> ::::: Parse KMA MOTION Radar Header Info :::::");
			...
			System.out.println(this.logDateFormat.format(new Date(System.currentTimeMillis())) + " -> ::::: Parse KMA MOTION Radar Layer Raw Data :::::");
		...
		System.out.println(this.logDateFormat.format(new Date(System.currentTimeMillis())) + " -> ::::: End KMA MOTION Radar Image Converter :::::");
	}
