...
public class RadarKmaHailConveter {
	...
	private Lambert lambert = new Lambert(GRID_PARAM_TYPE.RDR_KMA_HAIL);
	...
	public RadarKmaHailConveter(DaemonSettings daemonSettings, ProcessorInfo processorInfo) {
	...
	public void parseRadarFile(File radarGZipFile) {
		...
		try {
			...
			System.out.println(this.logDateFormat.format(new Date(System.currentTimeMillis())) + " -> ::::: Parse KMA HAIL Radar Header Info :::::");
