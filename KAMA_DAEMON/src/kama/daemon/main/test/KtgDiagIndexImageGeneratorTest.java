...
public class KtgDiagIndexImageGeneratorTest {
	...
	public KtgDiagIndexImageGeneratorTest() {		
	...
	private void initCoordinates() {
		...
		String coordinatesLatPath = "F:/data/datastore/grid/ktg_lat.bin";
		String coordinatesLonPath = "F:/data/datastore/grid/ktg_lon.bin";
	...
	public static void main(String[] args) {
		...
		KtgDiagIndexImageGeneratorTest test = new KtgDiagIndexImageGeneratorTest();
                  
		try {
						
			NetcdfDataset ncFile = NetcdfDataset.acquireDataset("F:/KAMA_AAMI/2025/난류진단지수/sample.251026/amo_gdum_ktgm_midl_indx_f00_2025102600.nc", null);
			String fileName = "amo_gdum_ktgm_midl_indx_f00_2025102600.nc";
	        String savePath = "F:/data/ktg_diag_index_img";
