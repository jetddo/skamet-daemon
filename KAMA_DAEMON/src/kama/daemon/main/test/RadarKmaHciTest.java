...
//			return new Color(128,128,128);
	...
	private void createImage(float[][] radarLayerRegridData, int index) {
		...
		String imageFilePath = "F:/data/radar_kma_hci/radar_kma_hci_" + String.format("%03d", index)  + ".png";
	...
	public static void main(String[] args) {
		...
		RadarKmaHciTest radarTest = new RadarKmaHciTest();
		
		radarTest.parseRadarFile("F:/data/ftp/RDR_R3D_KMA_HCI_201912021300.bin.gz");
	}
