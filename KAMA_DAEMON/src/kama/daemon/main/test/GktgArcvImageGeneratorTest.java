...
public class GktgArcvImageGeneratorTest {
	...
	public GktgArcvImageGeneratorTest() {
	...
	private void initCoordinates() {
		...
		String coordinatesLatPath = "F:/data/datastore/grid/gktg_arcv_lat.bin";
		String coordinatesLonPath = "F:/data/datastore/grid/gktg_arcv_lon.bin";
			...
			for(int j=0 ; j<40 ; j++) {
				...
				for(int k=0 ; k<rows ; k++) {
					...
					for(int l=0 ; l<cols ; l++) {
						...
						Color c = (Color)gktgArcvLegendFilter.getClass().getMethod("getColor_" + this.varName, double.class).invoke(gktgArcvLegendFilter, v);
	...
	public static void main(String[] args) {
		...
		GktgArcvImageGeneratorTest gktgArcvImageGeneratorTest = new GktgArcvImageGeneratorTest();
                  
		try {
						
			NetcdfDataset ncFile = NetcdfDataset.acquireDataset("F:/KAMA_AAMI/2025/항기청_수신/항기청_수신_20250610/amo_gdum_gktg_f00_2025060812_arcv.nc", null);
			String fileName = "amo_gdum_gktg_f00_2025060812_arcv.nc";
	        String savePath = "F:/data/gktg_arcv_img";
	        
	        gktgArcvImageGeneratorTest.generateImages(ncFile, fileName, savePath);
