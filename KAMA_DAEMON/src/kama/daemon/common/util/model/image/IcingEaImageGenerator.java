...
import kama.daemon.common.util.model.legendfilter.IcingEaLegendFilter;
import net.coobird.thumbnailator.Thumbnails;
import ucar.ma2.Range;
import ucar.nc2.Variable;
import ucar.nc2.dataset.NetcdfDataset;

public class IcingEaImageGenerator {
	...
	public IcingEaImageGenerator(DatabaseManager dbManager, ProcessorInfo processorInfo, String attrName, String varName) {
	...
	private void initCoordinates() {
		...
		System.out.println("IcingEaImageGenerator [ Initailize Coordinate Systems ]");
		...
		this.modelGridUtil = new ModelGridUtil(ModelGridUtil.Model.ICING_EA, null, coordinatesLatPath, coordinatesLonPath);
	}
	
	public void generateImages(NetcdfDataset ncFile, String fileName, String savePath) {

		System.out.println("IcingEaImageGenerator [ Start Create Tile Images ]");		
		System.out.println("\t-> Create IcingEa Image Grid List");
		...
		System.out.println("IcingEaImageGenerator [ End Create Image ]");
	}
	...
	public BoundLonLat generateImage(NetcdfDataset ncFile, String fileName, String savePath) {
		...
		try {
			...
			IcingEaLegendFilter icingEaLegendFilter = new IcingEaLegendFilter();
